...
const AboutHero = () => {
  return (
    <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row items-center bg-white mt-16 md:mt-32 px-4">
      {/* Left Section */}
      <section className="w-full md:w-[650px] h-auto md:h-[478px] bg-[#007580] p-6 flex flex-col justify-start items-start text-left text-white">
        ...
        <div className="pl-4 md:pl-6">
          <button className="bg-[#2e6a6d] text-white px-6 md:px-8 py-3 md:py-4 text-[14px] md:text-[16px] font-normal focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#2e6a6d]">
            View Collection
          </button>
        </div>
      </section>
