    ...
    <nav className="w-full bg-white pt-[14px] pb-[14px]">
      <div className="max-w-screen-xl mx-auto flex items-center justify-between px-4 lg:px-0 ml-3">
        ...
        <div className="hidden md:flex gap-8 ml-3">
          <Link href="/" className="text-[#007580] text-[14px] font-medium hover:text-[#005d5d]">
            Home
          </Link>

          <Link href="/Product" className="text-[14px] font-medium hover:text-[#005d5d]">
            Product
          </Link>

          <Link href="/SingleProduct" className="text-[14px] font-medium hover:text-[#005d5d]">
            Single Product
          </Link>
      ...
      {isMenuOpen && (
        <div className="lg:hidden flex flex-col gap-4 mt-4 px-4">
          <Link href="/" onClick={closeMenu} className="text-[#007580] text-[14px] font-medium hover:text-[#005d5d]">
            Home
          </Link>
