    ...
    <div className="max-w-screen-xl mx-auto px-4 py-8">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          <h2 className="text-2xl lg:text-3xl font-medium pl-3 mb-6">Bag</h2>
          <div className="flex flex-col sm:flex-row items-center justify-between bg-white p-4 rounded-lg shadow-md mb-4">
            <div className="flex items-center space-x-4 sm:space-x-6">
              <div className="w-24 h-24 bg-orange-200 rounded">
                <Image src="/pictures/chair3.png" alt="." width={150} height={150} />
              </div>
              <div>
                <h3 className="text-lg sm:text-xl font-normal text-[#272343] mb-3">Library Stool Chair</h3>
                <p className="text-sm text-gray-500 mb-1">Ashen Slate/Cobalt Bliss</p>
                <div className="flex space-x-6 sm:space-x-12">
                  <p className="text-sm font-normal text-[#757575]">Size: L</p>
            ...
            <div className="flex gap-3 mt-3 sm:mt-0">
              <p className="text-lg font-normal text-[#111111]">MRP:</p>
              <p className="text-lg font-normal text-[#111111]">$99</p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between bg-white p-4 rounded-lg shadow-md">
            <div className="flex items-center space-x-4 sm:space-x-6">
              <div className="w-24 h-24 bg-gray-300 rounded">
                <Image src="/pictures/Image (3).png" alt="." width={150} height={150} />
              </div>
              <div>
                <h3 className="text-lg sm:text-xl font-normal text-[#272343] mb-3">Library Stool Chair</h3>
                <p className="text-sm font-normal text-[#757575] mb-1">Ashen Slate/Cobalt Bliss</p>
                <div className="flex space-x-6 sm:space-x-12">
                  <p className="text-sm font-normal text-[#757575]">Size: L</p>
                  <p className="text-sm font-normal text-[#757575]">Quantity: 1</p>
                </div>
